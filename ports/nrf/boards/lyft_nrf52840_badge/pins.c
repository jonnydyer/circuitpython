...
STATIC const mp_rom_map_elem_t board_module_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_LED1), MP_ROM_PTR(&pin_P1_06) },
    { MP_ROM_QSTR(MP_QSTR_NEOPIXEL), MP_ROM_PTR(&pin_P0_15) },
    { MP_ROM_QSTR(MP_QSTR_EN_3V3A), MP_ROM_PTR(&pin_P1_03) },

    { MP_ROM_QSTR(MP_QSTR_SW1), MP_ROM_PTR(&pin_P1_02) },
